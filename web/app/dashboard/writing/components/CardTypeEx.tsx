        ...
        <>
            {types?.map((type, index) => (
                ...
                >
                    <Card
                        key={type.id}
                        className={`relative group hover:shadow-lg transition-all duration-300 hover:-translate-y-1 border-2 hover:border-primary/50 flex flex-col justify-between overflow-hidden`}
                    >
