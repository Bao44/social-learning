          ...
          <div className="space-y-4">
            ...
            <div className="flex flex-col md:flex-row gap-4">
              <div className="flex-1 flex gap-2">
                ...
                />
                <Button onClick={handleSearch} size="icon" className="bg-linear-to-r from-orange-500 to-pink-500 text-white hover:from-orange-600 hover:to-pink-600 cursor-pointer">
                      ...
                      <TableRow key={user.id}>
                        ...
                        <TableCell>
                          <Button
                            ...
                            className="cursor-pointer bg-linear-to-r hover:text-white hover:from-orange-500 hover:to-pink-500"
                          >
                            {t("dashboard.view")}
                          </Button>
                        </TableCell>
