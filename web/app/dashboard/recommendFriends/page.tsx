  ...
  return (
    <>
      <div className="fixed inset-0 overflow-hidden pointer-events-none">
        ...
        />
        <motion.div
          className="absolute bottom-20 right-50 w-96 h-96 bg-linear-to-br from-purple-300/30 to-orange-300/30 rounded-full blur-3xl"
          animate={{
            scale: [1.2, 1, 1.2],
            rotate: [90, 0, 90],
          }}
                ...
                >
                  ...
                  <div className="text-right flex-shrink-0 px-2 sm:px-3">
                    ...
                    >
                      <Button
                        size="sm"
                        className="px-2 sm:px-3 text-xs sm:text-sm bg-linear-to-r from-orange-500 to-pink-500 hover:from-orange-600 hover:to-pink-600 text-white cursor-pointer"
                      >
